...
geometry_msgs::TwistStamped control_velocity;
  ...
  if (elapsed_time > ros::Duration(0.01)) {
    ...
    if (true) {
      ...
      if (current_gps_health > 3) {
        ...
        controllerPC.axes.push_back(control_velocity.twist.angular.x);
        controllerPC.axes.push_back(control_velocity.twist.angular.y);
        controllerPC.axes.push_back(control_velocity.twist.linear.z);
        controllerPC.axes.push_back(control_velocity.twist.angular.z);
...
void control_velocity_callback(const geometry_msgs::TwistStamped::ConstPtr& msg)
{
